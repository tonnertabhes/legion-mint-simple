export const CONTRACT_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32[]", name: "passProof", type: "bytes32[]" },
      { internalType: "bytes32", name: "pass", type: "bytes32" },
    ],
    name: "mint",
    outputs: [],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "newWhitelistRoot", type: "bytes32" },
    ],
